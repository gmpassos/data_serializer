...
void main() {
  group('extension', () {
    ...
    test('ListGenericExtension', () {
      ...
      expect(
        (l2.toUint64List() as List<int>).copy(),
        allOf(equals([10, 20, 30, 40, 50, 60, 70, 80]), isA<Uint64List>()),
      );

      // ignore: unnecessary_cast
      expect(
        (l2.toInt64List() as List<int>).copy(),
    ...
    test('Uint32ListDataExtension', () {
      ...
      expect(
        ns32b.convertToUint64List(Endian.little),
    ...
    test('Uint64ListDataExtension', () {
      ...
      expect(
        ns64.convertToUint8List(),
        equals([0, 2, 3, 4, 5, 6, 7, 8, 0, 3, 4, 5, 6, 7, 8, 9]),
      );

      expect(
        ns64.convertToUint8List(Endian.big),
        equals([0, 2, 3, 4, 5, 6, 7, 8, 0, 3, 4, 5, 6, 7, 8, 9]),
      );

      expect(
        ns64.convertToUint8List(Endian.little),
      ...
      expect(
        ns64.convertToUint32List(),
        equals([0x0020304, 0x05060708, 0x00030405, 0x06070809]),
      );

      expect(
        ns64.convertToUint32List(Endian.big),
        equals([0x0020304, 0x05060708, 0x00030405, 0x06070809]),
      );

      expect(
        ns64.convertToUint32List(Endian.little),
